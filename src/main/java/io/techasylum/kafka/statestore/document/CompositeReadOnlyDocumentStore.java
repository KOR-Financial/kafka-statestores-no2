 ...
 */
public class CompositeReadOnlyDocumentStore<K, V, F, O> implements ReadOnlyDocumentStore<K, V, F, O> {

    private final StateStoreProvider storeProvider;
    private final QueryableStoreType<ReadOnlyDocumentStore<K, V, F, O>> storeType;
    private final String storeName;

    public CompositeReadOnlyDocumentStore(final StateStoreProvider storeProvider,
                                          final QueryableStoreType<ReadOnlyDocumentStore<K, V, F, O>> storeType,
    ...
    public V get(final K key) {
        ...
        final List<ReadOnlyDocumentStore<K, V, F, O>> stores = storeProvider.stores(storeName, storeType);
        ...
        for (final ReadOnlyDocumentStore<K, V, F, O> store : stores) {
            try {
